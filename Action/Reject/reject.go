...
func Rejecting(t sdkInit.Application, args []string) (string, error) {
	...
	if err != nil {
		return "", fmt.Errorf(">>failed to reject: %v", err)
	}
...
func main() {
	...
	args := []string{"Reject", "jeweler01", "003"}
